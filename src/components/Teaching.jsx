      ...
      <div className="container-custom relative">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          <div className="lg:sticky lg:top-28 reveal">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">{p.p1}</p>
            <p className="text-gray-600 leading-relaxed mb-8">{p.p2}</p>
            <div className="bg-navy-900 rounded-2xl p-6 text-white">
              ...
              <p className="text-white/80 italic leading-relaxed">"{p.quote}"</p>
              <p className="text-crimson-400 text-sm font-semibold mt-3">— {p.quoteAuthor}</p>
            </div>
          </div>
